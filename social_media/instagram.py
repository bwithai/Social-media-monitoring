...
def fetch_profile_data(profile_url, max_posts):
    ...
    profile_directory = "Default"  # Specify your profile directory if needed
    ...
    for link in list(post_links)[:max_posts]:
        ...
        try:
            ...
            # Extract caption
            caption = ""
            caption_element = soup.find('span', class_='x193iq5w xeuugli x1fj9vlw x13faqbe x1vvkbs xt0psk2 x1i0vuye xvs91rp xo1l8bm x5n08af x10wh9bi x1wdrske x8viiok x18hxmgj')
            if caption_element:
